        ...
        <div className="container">
          ...
          <div className="paragraphs">
            <p>
              ...
              <strong> The In-Person Fair will be held {inPersonFair.weekday}, {inPersonFair.month} {inPersonFair.weekdate}<sup>{inPersonFair.weekdateOrdinal}</sup>, {inPersonFair.year} from {inPersonFair.timeRange} {inPersonFair.timeZone} on the TAMU campus (Location To Be Determined).</strong>
            </p>
            <p>
              Because of continuing concerns with accessibility, we will be holding a Virtual Fair this year as well.
              <strong> The Virtual Fair will take place {virtualFair.weekday}, {virtualFair.month} {virtualFair.weekdate}<sup>{virtualFair.weekdateOrdinal}</sup>, {virtualFair.year} from {virtualFair.timeRange} {virtualFair.timeZone} on Discord.</strong>
            </p>
            <p>
